...
export const checklistLabels: Array<[keyof Checklist, string]> = [
  ['mantra', 'Mantras'], ['sahasranama', 'Sahasranamas'], ['astottaranama', 'Ashtottaranamas'],
  ['kavacham', 'Kavacham'], ['panjaram', 'Panjaram'], ['archana', 'Archana'],
]
export const quotes = [
...
export const seedEntries: JapaEntry[] = [
  make(6, 3360, 'D1'), make(6, 6635, 'D2'), make(6, 6040, 'D3'), make(6, 7800, 'D4'), make(6, 6000, 'D5'), make(6, 5472, 'Entry'), make(6, 8360, 'D6'),
  make(5, 16000, 'Entry'), make(4, 8860, 'Entry'), make(3, 4407, 'Entry'), make(2, 7150, 'Entry'), make(1, 4475, 'Entry'), make(0, 9938, 'Entry'),
]
